...
<div class="agile-grids">	
    ...
    <script type="text/javascript">
        ...
        function addMoreRows(frm) {
            ...
            var recRow = '<tr id="rowCount'+rowCount+'"><td ><input name="trPrice" type="text" size="10%"  maxlength="60" style="margin:10px 37px 0 0;" /></td><td id="inventary_inventaryname"> <select name="trPrice" type="text" style="margin:10px 45px 0 0;"> <option value="">Select...</option> <option value="M">Male</option> <option value="F">Female</option> </select> </td><td id="inventary_sku"><input  name="trPrice" type="text" size="10%"  maxlength="60" style="margin:10px 40px 0 0;"/> </td><td id="inventary_batchnumber"> <input  name="trPrice" type="number" size="10%"  maxlength="60" style="margin:10px 20px 0 0;"/> </td> <td id="inventary_quantity"> <input  name="trPrice" type="number" size="10%"  maxlength="60" style="margin:10px 20px 0 0;"/> </td> <td id="inventary_expirydate"> <input   name="trPrice" type="date" size="10%"  maxlength="60" style="margin:10px 20px 0 0;"/> </td> <td><a href="javascript:void(0);" onclick="removeRow('+rowCount+');">Delete</a></td></tr>';
            jQuery('#addedRows').append(recRow);
