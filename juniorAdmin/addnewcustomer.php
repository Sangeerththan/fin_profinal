				   ...
				   <div class="tab-pane active" id="horizontal-form_1">
					   <form class="form-horizontal" method = "post" action = "<?php echo "addCustomer.php".$post_pass_value ?>">
						   ...
						   <div class="form-group">
							   ...
							   <div >
								   <input type="text" onkeyup="contactperson()" value="<?php if(isset($_GET['contactPerson'])) { echo $_GET['contactPerson'];}?>"class="form-control1" name = "contactPerson" id="addnewcustomer_contactperson" placeholder="Contact Person" required>
							   </div>
						   </div>
						   <div class="form-group">
